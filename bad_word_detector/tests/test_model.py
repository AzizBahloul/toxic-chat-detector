# bad_word_detector/tests/test_model.
...
class TestBadWordDetector:
    ...
    def test_toxic_content_detection(self):
        ...
        for text in toxic_examples:
            ...
            assert result["is_toxic"] is True, (
                f"Failed to detect toxic content in: '{text}'"
            )
    ...
    def test_non_toxic_content(self):
        ...
        for text in non_toxic_examples:
            ...
            assert result["is_toxic"] is False, (
                f"Incorrectly flagged non-toxic content as toxic: '{text}'"
            )
    ...
    def test_language_detection(self):
        ...
        for text, expected_lang in examples:
            ...
            assert result["detected_language"] in Config.SUPPORTED_LANGUAGES, (
                f"Detected language {result['detected_language']} not in supported list"
            )
...
class TestTextPreprocessor:
    ...
    def test_stopword_removal(self):
        ...
        cleaned_with_stopwords = self.preprocessor.clean_text(
            text, remove_stopwords=False
        )

        # Clean with stopword removal
        cleaned_without_stopwords = self.preprocessor.clean_text(
            text, lang="en", remove_stopwords=True
        )

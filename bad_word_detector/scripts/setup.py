...
# After adding to path, import our modules
...
def download_pretrained_models():
    ...
    try:
        from transformers import AutoTokenizer, AutoModelForSequenceClassification, AutoModelForTokenClassification  # type: ignore
...
def download_dataset():
    ...
    try:
        ...
        print(f"Downloading dataset {Config.DEFAULT_HF_DATASET} for all configured languages...")

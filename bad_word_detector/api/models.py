...
class TextRequest(BaseModel):
    ...
    threshold: Optional[float] = Field(0.5, description="Confidence threshold (0.0 to 1.0)")
...
class ToxicWord(BaseModel):
    ...
    position: Optional[int] = Field(None, description="Position in the text (word index)")

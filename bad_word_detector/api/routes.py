"""
API routes for bad word detection.
"""
...
from api.models import TextRequest, BatchTextRequest, TextResponse, HealthResponse
...
async def detect_bad_words(request: TextRequest, model: BadWordDetector = Depends(get_model)):
    """
...
async def detect_bad_words_batch(texts: List[str], 
